...
const modalTpl =
  ...
  "        </button>" +
  "      </div>" +
  '      <div class="modal-body text-white-f">' +
  "      </div>" +
...
const buttonTpl =
  '<button type="button" class="btn button-f px-3" data-dismiss="modal">{0}</button>';
const noTpl =
  '<button type="button" class="btn button-f px-3" data-dismiss="modal">Нет</button>';
const yesTpl =
  '<button type="button" class="btn button-f px-3" data-dismiss="modal">Да</button>';
