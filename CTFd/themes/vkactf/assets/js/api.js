...
let API = (function() {
   ...
   *
   * @method
   * @name API#confrontation
   * @param {object} parameters - method options and parameters
   */
  API.prototype.confrontation = function(parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    let deferred = Q.defer();
   ...
   *
   * @method
   * @name API#post_fbmessage_list
   * @param {object} parameters - method options and parameters
   */
   API.prototype.post_fbmessage_list = function(parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    let deferred = Q.defer();
    let domain = this.domain,
      path = "/firstbloods/messages";
    let body = {},
      queryParameters = {},
      headers = {},
      form = {};
   ...
   *
   * @method
   * @name API#get_fbmessage_list
   * @param {object} parameters - method options and parameters
   */
  API.prototype.get_fbmessage_list = function(parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    let deferred = Q.defer();
   ...
   *
   * @method
   * @name API#delete_fbmessage
   * @param {object} parameters - method options and parameters
   * @param {string} parameters.fbmessageId - A Firstblood Message ID
   */
  API.prototype.delete_fbmessage = function(parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    let deferred = Q.defer();
    let domain = this.domain,
      path = "/firstbloods/messages/{fbmessage_id}";
    let body = {},
      queryParameters = {},
      headers = {},
      form = {};
    ...
    path = path.replace("{fbmessage_id}", parameters["fbmessageId"]);

    if (parameters["fbmessageId"] === undefined) {
      deferred.reject(new Error("Missing required  parameter: fbmessageId"));
      return deferred.promise;
    }
   ...
   *
   * @method
   * @name API#get_fbmessage
   * @param {object} parameters - method options and parameters
   * @param {string} parameters.fbmessageId - A Firstblood Message ID
   */
  API.prototype.get_fbmessage = function(parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    let deferred = Q.defer();
