...
class ServerConfig(object):
    ...
    TG_BOT_SECRET: str = empty_str_cast(config_ini["oauth"]["TG_BOT_SECRET"])
    TG_BOT_USERNAME: str = empty_str_cast(config_ini["oauth"]["TG_BOT_USERNAME"])

    # === TG Notifications ===
    TG_BOT_NOTIFICATIONS_URL: str = empty_str_cast(config_ini["notifications"]["TG_BOT_NOTIFICATIONS_URL"])
    TG_BOT_NOTIFICATIONS_SECRET: str = empty_str_cast(config_ini["notifications"]["TG_BOT_NOTIFICATIONS_SECRET"])
    TG_BOT_NOTIFICATIONS_DEV_CHAT: str = empty_str_cast(config_ini["notifications"]["TG_BOT_NOTIFICATIONS_DEV_CHAT"])
    TG_BOT_NOTIFICATIONS_USERS_CHAT: str = empty_str_cast(config_ini["notifications"]["TG_BOT_NOTIFICATIONS_USERS_CHAT"])
