...
const modalTpl =
  ...
  '      <div class="modal-header label-f">' +
  '        <h5 class="modal-title">{0}</h5>' +
  '        <button type="button" class="close" data-dismiss="modal" aria-label="Close">' +
  '          <span class="text-white-f" aria-hidden="true">&times;</span>' +
  "        </button>" +
  "      </div>" +
  '      <div class="modal-body text-white-f challenge-desc">' +
  "      </div>" +
...
const buttonTpl =
  '<button type="button" class="btn button-f px-3" style="font-size: 16px;" data-dismiss="modal">{0}</button>';
const noTpl =
  '<button type="button" class="btn button-f px-3" style="font-size: 16px;" data-dismiss="modal">No</button>';
const yesTpl =
  '<button type="button" class="btn button-f px-3" style="font-size: 16px;" data-dismiss="modal">Yes</button>';
