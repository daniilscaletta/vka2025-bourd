    ...
    if is_admin() or is_setup() is False:
        ...
        if state:
            if name == "mlc":
                ...
                tg_bot_secret = request.values.get("tg_bot_secret")
                tg_bot_username = request.values.get("tg_bot_username")
                set_config("tg_bot_secret", tg_bot_secret)
                set_config("tg_bot_username", tg_bot_username)
                return render_template("admin/integrations.html")
