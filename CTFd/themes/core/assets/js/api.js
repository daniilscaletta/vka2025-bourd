...
let API = (function() {
   ...
   *
   * @method
   * @name API#post_message_list
   * @param {object} parameters - method options and parameters
   */
   API.prototype.post_message_list = function(parameters, body) {
    if (parameters === undefined) {
      parameters = {};
    }
    if (body === undefined) {
   ...
   *
   * @method
   * @name API#get_message_list
   * @param {object} parameters - method options and parameters
   */
  API.prototype.get_message_list = function(parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    let deferred = Q.defer();
   ...
   *
   * @method
   * @name API#delete_message
   * @param {object} parameters - method options and parameters
   * @param {string} parameters.messageId - A Message ID
   */
  API.prototype.delete_message = function(parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    let deferred = Q.defer();
    ...
    path = path.replace("{message_id}", parameters["messageId"]);
   ...
   *
   * @method
   * @name API#get_message
   * @param {object} parameters - method options and parameters
   * @param {string} parameters.messageId - A Message ID
   */
  API.prototype.get_message = function(parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    let deferred = Q.defer();
